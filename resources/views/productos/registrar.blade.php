	...
	<div class="col-12 col-sm-12 col-md-9" >
		<form action="/products/store" method="get">
			...
			<div class="form-group">
				...
				<input required="" type="number" class="form-control" name="ganancia" id="ganancia">
			</div>
			<div class="form-group">
				<label>Imagen</label>				
			...
			<div class="form-group">
				...
				<input required="" type="text" class="form-control" name="medidas" id="medidas">
			</div>
			<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input required="" type="number" class="form-control" name="ppu" id="ppu">
					</div>
				</div>
